...
/**
 * Comminication/messagensHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class CollectionStringHelper {
	private static String _id = "IDL:Comminication/messagens:1.0";
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			...
			__typeCode = org.omg.CORBA.ORB.init().create_alias_tc(
					CollectionStringHelper.id(), "messagens", __typeCode);
		}
		return __typeCode;
	}
